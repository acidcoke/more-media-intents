...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    # them to be. Because we have patched the MoreMediaIntentsDataUpdateCoordinator.async_get_data
    # call, no code from custom_components/more_media_intents/api.py actually runs.
