...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    coordinator = MoreMediaIntentsDataUpdateCoordinator(hass, client=client)
...
class MoreMediaIntentsDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    def __init__(
        self,
        hass: HomeAssistant,
        client: MoreMediaIntentsApiClient,
    ) -> None:
        """Initialize."""
        self.api = client
        self.platforms = []
